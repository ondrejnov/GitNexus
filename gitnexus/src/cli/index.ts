...
program
  .command("setup")
  .description(
    "One-time setup: configure MCP for Cursor, Claude Code, OpenCode",
  )
...
program
  ...
  .option(
    "--manifest <path>",
    "Merge an external FE/BE dependency manifest into the graph before community/process detection",
  )
...
program
  .command("agents [path]")
  .description("Install base GitNexus skills and update AGENTS.md")
  .action(createLazyAction(() => import("./agents.js"), "agentsCommand"));
